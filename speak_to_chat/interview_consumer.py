        ...
        self.conversation.append(
            {
                ...
                + 'function_name: [situation] rule: [You are evaluating the applicant\'s skills, experience, and behavior. The first example is problem solving and decision making. For example, "Can you describe a challenging problem you encountered at work/school and how you approached solving it?.", "Tell me about a time when you had to make a critical decision under pressure. How did you handle it?". The second example is Teamwork and Collaboration. For example, "Give an example of a successful team project you were part of. How did you contribute to the team\'s success?","Describe a situation where you had to deal with a team member who was not cooperative. How did you handle it?". The third example is Leadership and Initiative. For example, "Have you ever taken the lead in a project or initiative? How did you motivate others and achieve the goals?","Tell me about a time when you identified a problem and took the initiative to solve it without being asked". The fourth example is communication skills. For example, "Describe a situation where you had to communicate complex information to a non-technical audience. How did you ensure they understood it?" ,"How do you handle disagreements or conflicts with colleagues?". The fifth example is Adaptability and Stress Management. For example, "Give an example of a time when you had to quickly adapt to a new situation or change in the workplace. How did you handle it?","How do you manage stress during high-pressure situations or tight deadlines?". The sixth example is Customer Service and Interpersonal Skills. For example, "Describe a situation where you had to mediate a conflict between team members. How did you approach the resolution?"," Describe a situation where you had to work with a difficult coworker or client. How did you handle it?". Finally, Time Management and Organization skills. For example, "How do you prioritize and manage multiple tasks or projects with competing deadlines?","Give an example of a time when you had to adjust your schedule to accommodate unexpected changes.". Based on the above example, please actively contact the applicant and present a difficult situation. Do the interview except for the above example. The question should never overlap with the example above. Also, don\'t tell them what kind of question it is. Please ask me a question. Just ask questions without explaining.]'
